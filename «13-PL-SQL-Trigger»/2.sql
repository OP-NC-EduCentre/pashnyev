...
CREATE OR REPLACE TRIGGER user_insert_check_this
    BEFORE INSERT
    ON car
    FOR EACH ROW
DECLARE
...
insert into car (car_id,user_id,make,mode_car) values(1005,100000,'Volfswagen','passat')
Error report -
ORA-20551: No user with id=100000
ORA-06512: at "PASHNYEV.USER_INSERT_CHECK_THIS", line 10
ORA-04088: error during execution of trigger 'PASHNYEV.USER_INSERT_CHECK_THIS'
*/
